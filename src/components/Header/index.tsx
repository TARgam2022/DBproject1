            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                <Link href={user ? "/my-account" : "/signin"} className="flex items-center gap-2.5">
                  {user?.image ? (
                    <div className="w-8 h-8 rounded-full overflow-hidden flex items-center justify-center border border-gray-3">
                    ...
                    <div className="w-8 h-8 rounded-full flex items-center justify-center bg-blue/10">
                      {user ? (
                        <span className="font-semibold text-blue text-sm leading-none">
