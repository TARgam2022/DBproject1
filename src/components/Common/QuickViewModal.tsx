...
import CategoryChipById from "./CategoryChipById";
        ...
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content">
          ...
          <div className="flex flex-wrap items-center gap-12.5">
            ...
            <div className="max-w-[445px] w-full">
              ...
              <CategoryChipById categoryId={product.categoryId} categoryIds={product.categoryIds} />

              <p>
                {product.description || "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has."}
              </p>
