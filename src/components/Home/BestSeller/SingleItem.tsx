      ...
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          ...
          <span className="flex items-center justify-center gap-2 font-medium text-lg">
            <span className="text-dark">${item.discountedPrice < item.price ? item.discountedPrice : item.price}</span>
        ...
        <div className="flex justify-center items-center">
          <ProductImage src={item.imgs.previews[0]} alt="" width={280} height={280} />
        </div>
        ...
        <div className="absolute right-0 bottom-0 translate-x-full u-w-full flex flex-col gap-2 p-5.5 ease-linear duration-300 group-hover:translate-x-0">
          ...
          <WishlistHeart
            item={item}
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 bg-white hover:bg-blue"
          />
        </div>
      </div>
    </div>
